...
<div class="card">
  ...
  <div class="card-body">
       ...
       {!! Form::open(['url' => route('malls.update',$mall->id),'files' => true]) !!}
       @method('PUT')
...
<!-- ---------------------------------------------------------------------------------------- -->
     <div class="form-group col-md-6">
       ...
       {!! Form::text("name_en",value($mall->name_en),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- -->
    <div class="form-group col-md-6">
       ...
       {!! Form::text("name_ar",value($mall->name_ar),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- -->   
  ...
  <div class="form-group col-md-6">
       ...
       {!! Form::text("contact_name",value($mall->contact_name),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- --> 
  ...
  <div class="form-group col-md-6">
       ...
       {!! Form::text("facebook",value($mall->facebook),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- --> 
     ...
     <div class="form-group col-md-6">
       ...
       {!! Form::email("email",value($mall->email),['class' => 'form-control']) !!}
         @if($errors->has('email'))
...
<!-- ---------------------------------------------------------------------------------------->
   ...
   <div class="form-group col-md-6">
       ...
       {!! Form::text("mobile",value($mall->mobile),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------->
  ...
  <div class="form-group col-md-6">
       ...
       {!! Form::text("twitter",value($mall->twitter),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- -->
   <div class="form-group col-md-6">
       ...
       {!! Form::text("website",value($mall->website),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------->
   ...
   <div class="form-group col-md-6">
       ...
       {!! Form::select("country_id",$countries,value($mall->country_id),['class' => 'form-control', 'placeholder' => "......"]) !!}
...
<!-- ---------------------------------------------------------------------------------------->
   ...
   <div class="form-group col-md-6">
       ...
       {!! Form::text("address",value($mall->address),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------->
 ...
 <div class="form-group col-md-12">
    ...
    @if(!empty($mall->icon))
       ...
       <img src="{{asset('storage/'.$mall->icon)}}" width="75" height="75">
       <br>
       <br>
