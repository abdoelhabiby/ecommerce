  ...
  <div id="wrapper">
    ...
    <hr class="sidebar-divider my-0">
      ...
      <li class="nav-item {{ request()->segment(3) == 'setting' ? 'active' : ''}}">
        ...
        <a class="nav-link" href="{{url('dashboard/setting')}}">
          ...
          <span>{{trans('admin.setting')}}</span></a>
    ...
    <hr class="sidebar-divider my-0">
      ...
      <li class="nav-item {{ request()->segment(3) == 'cities' || request()->segment(3) == 'states' || request()->segment(3) == 'countries' ? 'active' : ''}}">
        ...
        <div id="CountryCity" 
        class="collapse {{ request()->segment(3) == 'cities' || request()->segment(3) == 'states' || request()->segment(3) == 'countries' ? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">

              <a class="collapse-item " href="{{url(route('countries.index'))}}" 
                style="{{ request()->segment(3) == 'countries' ? 'background-color: #DDD' : ''}}">
                <i class="fas fa-fw fa-flag"></i>
                <span>{{trans('admin.countries')}}</span>
              </a>

             <a class="collapse-item" href="{{url(route('cities.index'))}}"
             style="{{ request()->segment(3) == 'cities' ? 'background-color: #DDD' : ''}}">
              <i class="fas fa-fw fa-map-marker"></i>
              <span>{{trans('admin.cities')}}</span>
             </a>

             
             <a class="collapse-item" href="{{url(route('states.index'))}}"
             style="{{ request()->segment(3) == 'states' ? 'background-color: #DDD' : ''}}">
              <i class="fas fa-fw fa-map-marker"></i>
    ...
    <hr class="sidebar-divider my-0">
      ...
      <li class="nav-item {{ request()->segment(3) == 'categories' ? 'active' : ''}}">
        ...
        <div id="Category" 
        class="collapse {{ request()->segment(3) == 'categories' ? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
