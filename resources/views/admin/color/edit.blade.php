...
<div class="card">
  ...
  <div class="card-body">
       ...
       {!! Form::open(['url' => route('colors.update',$color->id),'files' => true]) !!}
       @method('PUT')
<!-- ---------------------------------------------------------------------------------------- -->
     <div class="form-group">
       {!! Form::label('name_en', trans('admin.name_en'), ['class' => 'awesome']) !!} 
       {!! Form::text("name_en",value($color->name_en),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- -->
    <div class="form-group">
       ...
       {!! Form::text("name_ar",value($color->name_ar),['class' => 'form-control']) !!}
...
<!-- ---------------------------------------------------------------------------------------- --> 
    <div class="form-group">
       {!! Form::label('color',trans('admin.color'), ['class' => 'awesome']) !!} 
       {!! Form::color("color",value($color->color),['class' => 'form-control']) !!}
         @if($errors->has('color'))
             <p class="text-danger text-uppercase">{{$errors->first('color')}}</p>
         @endif
    </div> 
