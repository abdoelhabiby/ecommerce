...
class ColorDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('color', 'admin.dataTables.buttonAction.color.color')
            ->addColumn('edit', 'admin.dataTables.buttonAction.color.edit')
            ->addColumn('delete', 'admin.dataTables.buttonAction.color.delete');
