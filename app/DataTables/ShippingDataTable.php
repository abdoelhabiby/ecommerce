...
class ShippingDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'admin.dataTables.buttonAction.shipping.edit')
            ->addColumn('delete', 'admin.dataTables.buttonAction.shipping.delete');
    ...
    public function query()
        {
            $admin = Shipping::with('user')->select();
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('user.name')->title(trans('admin.company_owner')),
